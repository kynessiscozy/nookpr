...
EX = [
    ...
    (8,"stretch","站立伸展","拉伸","柔韧","入门",3.0,"duration",None,60,"stretch",
     ...
     "拉伸到有牵拉感即可，不要弹震、不要憋气"),
    (9,"bridge","仰卧臀桥","下肢","力量","入门",5.5,"reps",16,None,None,
     ["仰卧屈膝，双脚靠近臀部踩地","臀部发力向上顶起，至肩髋膝成一条直线","顶峰夹紧臀部一秒，缓慢下落"],
     "发力重点在臀部，不要过度顶腰"),
    (10,"climber","登山跑","全身","有氧","中级",10.5,"duration",None,30,None,
     ["俯撑姿势，双手在肩下方、身体成直线","交替快速向胸前提膝，像原地跑步","保持髋部稳定不上下晃动"],
     "核心始终收紧，速度以动作不变形为前提"),
    (11,"wallsit","靠墙静蹲","下肢","稳定","初级",6.0,"duration",None,30,None,
     ["背靠墙站立，向前迈出双脚","沿墙下滑至大腿接近水平，小腿垂直地面","保持静蹲到目标时长，均匀呼吸"],
     "膝盖不超过脚尖，大腿酸了就结束"),
    (12,"tap","平板触肩","核心","稳定","中级",7.5,"reps",14,None,None,
